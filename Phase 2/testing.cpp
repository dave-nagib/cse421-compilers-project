...
//    parser.parse(input1,"F:\\NewProjects\\compilers\\compiler_lexical\\cmake-build-debug\\Test_2.txt");// Should produce leftmost derivation
//
//
...
//    std::cout << "\nParsing input: id + id" << std::endl;
//    parser.parse(input3,"F:\\NewProjects\\compilers\\compiler_lexical\\cmake-build-debug\\Test_1.txt"); // Should trigger error recovery
//
//
//}
//
...
//    parser.parse(input1,"F:\\NewProjects\\compilers\\compiler_lexical\\cmake-build-debug\\Test_5.txt");// Should produce leftmost derivation
//
//
...
//    parser.parse(input3,"F:\\NewProjects\\compilers\\compiler_lexical\\cmake-build-debug\\Test_6.txt"); // Should trigger error recovery
//}
//void whole_test(){
...
//    parser.parse({"int", "id", ";", "id", "=", "num", ";", "if", "(", "id", ">", "num", ")", "{", "id", "=", "num", ";", "}", "$"}, "F:\\NewProjects\\compilers\\compiler_lexical\\cmake-build-debug\\out.txt");
//
//    std::cout << "\nParsing Table: " << std::endl;
//    table.printTable();
//}
